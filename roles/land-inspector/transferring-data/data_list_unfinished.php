...
<head>
    ...
    <title>Lista de datos de transferencia sin finalizar</title>
...
<body>
    ...
    <div class="content" id="content">
        <h1>Lista de Datos de Transferencia sin finalizar</h1>

        <?php if (isset($_GET['data_list_success'])) { ?>
        ...
        <div class="table-container">
            <table class="list-table">
                ...
                <?php
                    $query = "SELECT id_data_trans, mes, año FROM data_trans_buque WHERE finalizado = 0;";
                    $result = mysqli_query($connection, $query);
                ...
                <tr>
                    ...
                    <td>
                        <form action="unfinished_form.php" method="POST">
